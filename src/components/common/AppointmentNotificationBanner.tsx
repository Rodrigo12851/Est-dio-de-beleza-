...
export const AppointmentNotificationBanner: React.FC<AppointmentNotificationBannerProps> = ({
  ...
  return (
    <div
      className="fixed top-4 left-4 right-4 sm:left-auto sm:right-6 sm:max-w-md z-50 bg-[#231F1C] text-white rounded-3xl p-4 sm:p-5 shadow-2xl border border-[#4D443D]"
    >
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-3">
          <div className="relative w-10 h-10 rounded-2xl bg-[#8E5D52] flex items-center justify-center text-white shrink-0 shadow-xs">
